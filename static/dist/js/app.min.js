...
$.fn.AdminSettings = function(i) {
    var t = this.attr("id"),
        a = (i = $.extend({}, {
            ...
            ManageTheme: function() {
                ...
                switch (i.Layout) {
                    case "vertical":
                        1 == a ? ($("body").attr("data-theme", "dark"), $("#theme-view").prop("checked", !0)) : ($("#" + t).attr("data-theme", "light"), $("body").prop("checked", !1))
                }
            },
            ManageThemeLayout: function() {
                switch (i.Layout) {
                    case "horizontal":
                        ...
                        break;
                    case "vertical":
                        $("#" + t).attr("data-layout", "vertical"), $(".scroll-sidebar").perfectScrollbar({})
                }
            },
            ManageThemeBackground: function() {
                var a, e;
                null != (a = i.LogoBg) && "" != a ? $("#" + t + " .topbar .top-navbar .navbar-header").attr("data-logobg", a) : $("#" + t + " .topbar .top-navbar .navbar-header").attr("data-logobg", "skin1"), null != (e = i.NavbarBg) && "" != e ? ($("#" + t + " .topbar .navbar-collapse").attr("data-navbarbg", e), $("#" + t + " .topbar").attr("data-navbarbg", e), $("#" + t).attr("data-navbarbg", e)) : ($("#" + t + " .topbar .navbar-collapse").attr("data-navbarbg", "skin1"), $("#" + t + " .topbar").attr("data-navbarbg", "skin1"), $("#" + t).attr("data-navbarbg", "skin1"))
            },
            ManageSidebarType: function() {
                switch (i.SidebarType) {
                    ...
                    case "stylish":
                        ...
                        a = function() {
                            (0 < window.innerWidth ? window.innerWidth : this.screen.width) < 1170 ? ($("#main-wrapper").attr("data-sidebartype", "mini-sidebar"), $("#main-wrapper").addClass("mini-sidebar")) : ($("#main-wrapper").attr("data-sidebartype", "stylish"), $("#main-wrapper").removeClass("mini-sidebar"))
                        };
                        $(window).ready(a), $(window).on("resize", a), $(".sidebartoggler").on("click", function() {
                            $("#main-wrapper").toggleClass("mini-sidebar"), $("#main-wrapper").hasClass("mini-sidebar") ? ($(".sidebartoggler").prop("checked", !0), $("#main-wrapper").attr("data-sidebartype", "mini-sidebar")) : ($(".sidebartoggler").prop("checked", !1), $("#main-wrapper").attr("data-sidebartype", "stylish"))
                        });
                        break;
                    case "mini-sidebar":
                        $("#" + t).attr("data-sidebartype", "mini-sidebar"), $(".sidebartoggler").on("click", function() {
            ...
            ManageSidebarColor: function() {
                var a;
                null != (a = i.SidebarColor) && "" != a ? $("#" + t + " .left-sidebar").attr("data-sidebarbg", a) : $("#" + t + " .left-sidebar").attr("data-sidebarbg", "skin1")
            },
            ManageSidebarPosition: function() {
                ...
                switch (i.Layout) {
                    case "vertical":
                    case "horizontal":
                        1 == a ? ($("#" + t).attr("data-sidebar-position", "fixed"), $("#sidebar-position").prop("checked", !0)) : ($("#" + t).attr("data-sidebar-position", "absolute"), $("#sidebar-position").prop("checked", !1)), 1 == e ? ($("#" + t).attr("data-header-position", "fixed"), $("#header-position").prop("checked", !0)) : ($("#" + t).attr("data-header-position", "relative"), $("#header-position").prop("checked", !1))
                }
            },
            ManageBoxedLayout: function() {
                ...
                switch (i.Layout) {
                    case "vertical":
                    case "horizontal":
                        1 == a ? ($("#" + t).attr("data-boxed-layout", "boxed"), $("#boxed-layout").prop("checked", !0)) : ($("#" + t).attr("data-boxed-layout", "full"), $("#boxed-layout").prop("checked", !1))
                }
            }
        });
    a.AdminSettingsInit()
    ...
    $("#chat .message-center a").on("click", function() {
        ...
        if ($(this).hasClass("active")) $(this).toggleClass("active"), $(".chat-windows #user-chat" + i).hide();
        else if ($(this).toggleClass("active"), $(".chat-windows #user-chat" + i).length) $(".chat-windows #user-chat" + i).removeClass("mini-chat").show();
        else {
            var r = msg_receive("I watched the storm, so beautiful yet terrific."),
                s = "<div class='user-chat' id='user-chat" + i + "' data-user-id='" + i + "'>";
            s += "<div class='chat-head'><img src='" + e + "' data-user-id='" + i + "'><span class='status " + t + "'></span><span class='name'>" + a + "</span><span class='opts'><i class='ti-close closeit' data-user-id='" + i + "'></i><i class='ti-minus mini-chat' data-user-id='" + i + "'></i></span></div>", s += "<div class='chat-body'><ul class='chat-list'>" + (r += msg_sent("That is very deep indeed!")) + "</ul></div>", s += "<div class='chat-footer'><input type='text' data-user-id='" + i + "' placeholder='Type & Enter' class='form-control'></div>", s += "</div>", $(".chat-windows").append(s)
        }
        ...
        if (13 == a.keyCode) {
            var e = $(this).attr("data-user-id"),
                i = $(this).val();
            i = msg_sent(i), $(".chat-windows #user-chat" + e + " .chat-body .chat-list").append(i), $(this).val(""), $(this).focus()
        }
